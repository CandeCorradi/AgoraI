...
namespace Backend.Migrations
{
    ...
    [Migration("20251110035147_FechaInscripcion")]
    partial class FechaInscripcion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Service.Models.Capacitacion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaHora = new DateTime(2025, 11, 20, 0, 51, 43, 201, DateTimeKind.Local).AddTicks(5983),
                        ...
                        new
                        {
                            ...
                            FechaHora = new DateTime(2025, 11, 30, 0, 51, 43, 201, DateTimeKind.Local).AddTicks(6001),
                            InscripcionAbierta = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 3,
                            Cupo = 20,
                            Detalle = "Aprende a diseñar y gestionar bases de datos SQL.",
                            FechaHora = new DateTime(2025, 11, 25, 0, 51, 43, 201, DateTimeKind.Local).AddTicks(6007),
                            InscripcionAbierta = true,
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = 4,
                            Cupo = 15,
                            Detalle = "Crea aplicaciones móviles para Android e iOS.",
                            FechaHora = new DateTime(2025, 12, 10, 0, 51, 43, 201, DateTimeKind.Local).AddTicks(6014),
                            InscripcionAbierta = true,
                            IsDeleted = false,
                            Nombre = "Desarrollo de Aplicaciones Móviles",
                            Ponente = "Marta Fernández"
                        },
                        new
                        {
                            Id = 5,
                            Cupo = 40,
                            Detalle = "Protege tus datos y dispositivos con buenas prácticas de ciberseguridad.",
                            FechaHora = new DateTime(2025, 12, 5, 0, 51, 43, 201, DateTimeKind.Local).AddTicks(6021),
                            InscripcionAbierta = true,
                            IsDeleted = false,
                            Nombre = "Ciberseguridad Básica",
                            Ponente = "Javier Sánchez"
                        });
                });
